...
def train_config(parser):
    ...
    # loading
    parser.add_argument("--model_ckpt", default='checkpoint/model_0.pt', type=str)
...
def main():
    logger.info('Launching the MTL training')
    opt = vars(args)
    # update data dir
    ...
    for epoch in range(0, args.epochs):
        ...
        for i, (batch_meta, batch_data) in enumerate(multi_task_train_data):
            ...
            if args.save_per_updates_on and ((model.local_updates) % (args.save_per_updates * args.grad_accumulation_step) == 0):
                ...
                logger.info('Saving mtl model to {}'.format(model_file))
            ...
            if dev_data is not None:
                ...
                for key, val in dev_metrics.items():
                    if args.tensorboard:
                        ...
                        #tensorboard.add_graph(model,dev_data)
